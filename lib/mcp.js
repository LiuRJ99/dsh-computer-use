...
// src/computer/index.ts
var COMPUTER_SETTINGS_NAMESPACE = "computer";
...
var LocalComputerEngine = class _LocalComputerEngine extends ComputerEngine {
  ...
  constructor(ctx, config) {
    ...
    ctx.inject(["settings"], (scope) => {
      scope.settings.installSection(ctx, COMPUTER_SETTINGS_NAMESPACE, _LocalComputerEngine.Config, entry, {
...
async function createServer(options = {}) {
  const helperPath2 = options.helperPath ?? process.env.DSH_COMPUTER_HELPER_PATH ?? defaultHelperPath();
